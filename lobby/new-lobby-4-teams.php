...
<div class="col-md-12">
    <div class="col-md-10 margin-off">
        ...
        <div class="col-md-3">
            <a href="addteam4.php?gameid=<?php echo $id; ?>&creator=<?php echo $creator; ?>">
                <div class="card">
                    <div class="card-body">
                        <div class="col-md-12 margin-off">
                            <div class="team-container margin-off col-md-12 text-center team-water">
                                <div class="col-md-12 team-logo ">
                                    <img src="../assets/img/logo-team/Water.jpg" alt="Water Logo">
                                </div>
                                <div class="col-md-12 margin-off">
                                    <h3 class="text-center team-name-water">
                                        WATER
                                    </h3>
                                </div>
                                <div class="col-md-12 margin-off players-list-water">
